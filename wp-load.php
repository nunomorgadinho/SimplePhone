...
if ( file_exists( ABSPATH . 'wp-config.php') ) {
	...
	wp_die(sprintf(/*WP_I18N_NO_CONFIG*/'O ficheiro <code>wp-config.php</code> parece não existir. Preciso dele antes de começar. Quer mais ajuda? <a href=\'http://codex.wordpress.org/Editing_wp-config.php\'>Nós temos</a>. Pode criar um ficheiro <code>wp-config.php</code> através do seu browser, mas isto não funciona em todos os servidores. A maneira mais segura é criar o ficheiro manualmente.</p><p><a href=\'%ssetup-config.php\' class=\'button\'>Criar Ficheiro de Configuração</a>'/*/WP_I18N_NO_CONFIG*/, $path), /*WP_I18N_ERROR_TITLE*/'WordPress &rsaquo; Erro'/*/WP_I18N_ERROR_TITLE*/, array('text_direction' => $text_direction));
