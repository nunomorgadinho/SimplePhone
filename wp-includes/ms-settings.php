...
// $base sanity check.
if ( 'BASE' == $base )
	die( /*WP_I18N_BASE_ERROR*/'Erro de configuração no ficheiro <code>wp-config.php</code>. <code>$base</code> está definido como <code>BASE</code>, quando deveria ser um caminho como <code>/</code> ou <code>/blogs/</code>.'/*/WP_I18N_BASE_ERROR*/ );
...
if ( !isset( $current_site ) || !isset( $current_blog ) ) {
	...
	if ( false !== strpos( $domain, ':' ) ) {
		if ( substr( $domain, -3 ) == ':80' ) {
			...
			wp_die( /*WP_I18N_NO_PORT_NUMBER*/'Multisite só funciona sem o número de porta na URL.'/*/WP_I18N_NO_PORT_NUMBER*/ );
		}
	}
	...
	if ( ! $blog_id ) {
		if ( defined( 'WP_INSTALLING' ) ) {
			...
			$msg = ! $wpdb->get_var( "SHOW TABLES LIKE '$wpdb->site'" ) ? ' ' . /*WP_I18N_TABLES_MISSING*/'Tabelas da base de dados em falta.'/*/WP_I18N_TABLES_MISSING*/ : '';
			wp_die( /*WP_I18N_NO_BLOG*/'Nenhum site com esse nome neste sistema.'/*/WP_I18N_NO_BLOG*/ . $msg );
		}
	}
}
